...
//
// mbr.Table implements the Table interface in github.com/ejfkdev/udf/diskkit/partition
//
// Normally, the best way to interact with a disk is to use the github.com/ejfkdev/udf/diskkit package,
