...
import (
	...
	"github.com/ejfkdev/udf/diskkit/util/slices"
...
func superblockFromBytes(b []byte) (*superblock, error) {
	...
	// s_checksum_type is only meaningful when the metadata_csum ro_compat
	// feature is enabled; filesystems created without it leave this byte 0.
	// Only validate it in that case.
